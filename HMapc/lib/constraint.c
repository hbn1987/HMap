...
void constraint_lookup_index_for_ipvx(mpz_t ipvx, constraint_t *con,
    ...
    if (mpz_lt_ui(radix_idx, con->radix_len)) {
        ...
        // log_debug("constraint", "ipvx: %s, prefix: %s, radix_offset: %s, index: %s, radix_idx: %s",
        // mpz_to_str10(ipvx), mpz_to_str10(con->radix[mpz_get_ui(radix_idx)]),  mpz_to_str10(radix_offset),
        // mpz_to_str10(index), mpz_to_str10(radix_idx));
